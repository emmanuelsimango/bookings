...
@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">You must log in to continue....</h3>
    </div>
        ...
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                <div class="card-header text-center">
                    ...
                    <h1 class="card-title text-primary">{{ __('Log in') }}</h1>
                </div>
                <div class="card-body">
                    <p class="text-dark mb-2">Sign in with <strong>your email </strong> and the <strong>password</strong></p>
